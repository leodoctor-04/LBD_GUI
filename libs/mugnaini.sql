create or replace package mugnaini as
    procedure add_lesson(p_idSessione in number,p_cdata in date,p_data in VARCHAR, p_inizio in VARCHAR, p_fine in VARCHAR, p_idcorso in NUMBER, p_idSala in NUMBER);
    procedure delete_lesson(p_idSessione in number,p_cdata in date, p_idLezione in number);

    procedure add_partecipazione(p_idsessione in number, p_cdata in date,p_idutente in number ,p_idlezione in number);
    procedure delete_partecipazione(p_idsessione in number, p_cdata in date,p_idutente in number ,p_idlezione in number);

    procedure calendario(p_idSessione in number default null, p_startDate in date default null, p_msg in varchar DEFAULT null);
end;
/

create or replace package body mugnaini as

    procedure add_lesson(p_idSessione in number,p_cdata in date,p_data in VARCHAR, p_inizio in VARCHAR, p_fine in VARCHAR, p_idcorso in NUMBER, p_idSala in NUMBER) is
        d date;
        sres number;
        d_inizio date; 
        d_fine date; 
    ...
    procedure delete_lesson(p_idSessione in number,p_cdata in date, p_idLezione in number) is
        res number;
    begin
    ...
    procedure add_partecipazione(p_idsessione in number, p_cdata in date,p_idutente in number ,p_idlezione in number) is
        res number;
    ...
    procedure delete_partecipazione(p_idsessione in number, p_cdata in date,p_idutente in number ,p_idlezione in number) is
        res number;
    begin
    ...
    procedure calendario(p_idSessione in number default null, p_startDate in date default null, p_msg in varchar DEFAULT null)AS
        -- constants
